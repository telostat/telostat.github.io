;(function($) {
  ...
  jQuery(document).ready(function() {
    ...
    function sideSlide() {
      ...
      var constructor = function() {
        if (!slide.hasClass("enabled")) {
          $("nav#menu")
            .detach()
            .appendTo("#Side_slide .menu_wrapper")
      ...
      var destructor = function() {
        if (slide.hasClass("enabled")) {
          ...
          $("nav#menu")
            .detach()
            .prependTo("#Top_bar .menu_wrapper")
    ...
    if (
      ...
      jQuery("body")
        .removeClass("nice-scroll-on")
        .addClass("nice-scroll")
      niceScrollFix()
    }
