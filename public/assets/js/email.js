...
function sendRequest() {
  ...
  try {
    ...
    jQuery("#contactWrapper").append(
      '<div class="success"><h4>Email Successfully Sent!</h4><br><p>Thank you for using our contact form <strong>' +
        decodeURIComponent(name) +
        "</strong>! Your email was successfully sent and we&#39;ll be in touch with you soon.</p></div>"
    )
  }
}
...
function sendRequest_news() {
  ...
  try {
    ...
    jQuery("#newsletterform")
      .parent()
      .append(
        '<div class="success"><h4>Subscription Successfully Sent!</h4><br><p>Your email: ' +
          email +
          " has been registered.</p></div>"
      )
  }
}
    ...
    if ($j("#contactform #name").val() == "") {
      ...
      if (!hasClass)
        $j("#contactform #name")
          .parent()
          .append(
            '<label for="contactname" generated="true" class="error">Please enter your name</label>'
          )
    ...
    if (validate_email($j("#contactform #email").val()) == false) {
      ...
      if (!hasClass)
        $j("#contactform #email")
          .parent()
          .append(
            '<label for="contactname" generated="true" class="error">Please enter a valid email address</label>'
          )
    ...
    if ($j("#contactform #subject").val() == "") {
      ...
      if (!hasClass)
        $j("#contactform #subject")
          .parent()
          .append(
            '<label for="contactname" generated="true" class="error">You need to enter a subject!</label>'
          )
    ...
    if ($j("#contactform #body").val() == "") {
      ...
      if (!hasClass)
        $j("#contactform #body")
          .parent()
          .append(
            '<label for="contactname" generated="true" class="error">You need to enter a message!</label>'
          )
    ...
    if ($j("#contactform #name").val() == "") {
      ...
      if (!hasClass)
        $j("#contactform #name")
          .parent()
          .append(
            '<label for="contactname" generated="true" class="error">Please enter your first name</label>'
          )
      $j("#contactform #name").focus()
      //return false;
      errors++
    ...
    if ($j("#contactform #name_s").val() == "") {
      ...
      if (!hasClass)
        $j("#contactform #name_s")
          .parent()
          .append(
            '<label for="contactname" generated="true" class="error">You need to enter your last name!</label>'
          )
  ...
  if ($j("#contactform_booking #surname").val() == "") {
    ...
    if (!hasClass)
      $j("#contactform_booking #surname")
        .parent()
        .append(
          '<label for="contactname" generated="true" class="error">Please enter your surname</label>'
        )
  ...
  if ($j("#contactform_booking #arrival").val() == "") {
    ...
    if (!hasClass)
      $j("#contactform_booking #arrival")
        .parent()
        .append(
          '<label for="contactname" generated="true" class="error">Please enter arrival date</label>'
        )
  ...
  if ($j("#contactform_booking #departure").val() == "") {
    ...
    if (!hasClass)
      $j("#contactform_booking #departure")
        .parent()
        .append(
          '<label for="contactname" generated="true" class="error">Please enter departure date</label>'
        )
  ...
  if ($j("#contactform_booking #room").val() == "") {
    ...
    if (!hasClass)
      $j("#contactform_booking #room")
        .parent()
        .append(
          '<label for="contactname" generated="true" class="error">Please enter your room nr</label>'
        )
  ...
  if ($j("#contactform_booking #adults").val() == "") {
    ...
    if (!hasClass)
      $j("#contactform_booking #adults")
        .parent()
        .append(
          '<label for="contactname" generated="true" class="error">Please enter adults nr</label>'
        )
  ...
  if ($j("#contactform_booking #children").val() == "") {
    ...
    if (!hasClass)
      $j("#contactform_booking #children")
        .parent()
        .append(
          '<label for="contactname" generated="true" class="error">Please enter children nr</label>'
        )
  ...
  if ($j("#contactform_booking #rooms").val() == "") {
    ...
    if (!hasClass)
      $j("#contactform_booking #rooms")
        .parent()
        .append(
          '<label for="contactname" generated="true" class="error">Please enter rooms nr</label>'
        )
